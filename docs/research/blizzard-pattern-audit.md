...
links to the inspected product and dependency repositories are intentionally
omitted under the [reference policy](../reference-policy.md); the audited
commits, paths, line ranges, conclusions, and verification results remain here.

## Scope and conclusion

This audit inspected `interest-protocol/blizzard` at the current `main` commit
`a1e5f7e910a1fd811ed0b537804e786b5788c7e2`
...
- If receipts support `join`, require every piece of metadata that affects
  ...
  (Walrus `staked_wal.move`, lines 146–174).
...
(`inner_protocol.move`, lines 319–390).
...
- The checkout is not self-contained: `blizzard/Move.toml` points to a Walrus
  ...
  `677f347f03e3db9f461bd29e16b120f10628a1b3`,
